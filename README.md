...
### Этот проект развлекательно-образовательной является MVP(minimum viable product) моделью и будет дальше улучшаться в интерфейсе, графике и многом другом. Будут добавлены новые игры, система очков, чтобы Вы могли соревноваться с друзьями, внутриигровая валюта за которую можно будет покупать доп. элементы для игры. Все, чтобы игроку было приятно провести часик-другой за игрой.
